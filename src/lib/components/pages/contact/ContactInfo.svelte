<script lang="ts">
  ...
  <div 
    ...
    class="bg-base-800 rounded-lg overflow-hidden border border-base-700 shadow-xl mb-8"
  >
    {#if infoVisible}
      <div class="p-8" in:fly={{ y: 20, duration: 500 }}>
        ...
        <div class="mt-8">
          ...
          <div class="flex space-x-4">
            <a href="#" class="w-10 h-10 bg-base-700 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors duration-300">
