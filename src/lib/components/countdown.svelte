...
<div class="mt-6 items-center justify-center">
	<ul class="flex flex-row items-center justify-center uppercase">
		{#if diff > 0}
			<div class="mx-2 h-20 w-20 items-center justify-center rounded-lg border-2 border-orange-700">
				<li class="my-3 flex flex-col items-center">
					{#if day === 1}
						<span class="text-center font-bold">Day</span>
					{:else}
						<span class="text-center font-bold">Days</span>
					{/if}
